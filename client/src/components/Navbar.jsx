        ...
        <div className ="flex items-center justify-between mx-4 py-3 lg:mx-44">
...

            {
                isSignedIn ? <div className="flex items-center gap-2 sm:gap-3">
                    <button className="flex items-center gap-2 bg-purple-50 px-4 py-1.5 sm:py-2.5 rounded-full border border-purple-200 hover:scale-105 transition-all duration-700 hover:bg-purple-100 hover:border-purple-300">
