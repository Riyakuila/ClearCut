    ...
    return(
        <div className='mx-4 my-3 lg:mx-44 mt-14 min-h-[75vh]'>
            ...
            <div className='flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6'>
                ...
                <a className='px-8 py-2.5 text-white bg-gradient-to-r from-violet-600 to-fuchsia-500 border rounded-full hover:scale-105 transition-all duration-700' href="">Download image</a>
            </div>
        </div>
    )
}
